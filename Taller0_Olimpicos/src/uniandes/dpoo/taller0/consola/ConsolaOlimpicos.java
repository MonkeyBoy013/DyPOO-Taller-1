...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta, y le informa cual pais reprsenta
	 */
	private void ejecutarPaisDeAtleta()
	{
		String nombre = input("Ingrese el nombre de un atleta: ");
		String resultado = calculadora.paisDeAtleta(nombre);
		System.out.println("El pais que representa " + nombre + " es " + resultado);
	}
